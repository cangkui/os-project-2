 ...
 * ****************************************************************************
 * widget.h / slots
 * void on_AddWork_clicked()                            添加作业进后备队列接口
 * void on_ViewBackQue_clicked()                        查看后备队列接口
 * void timerEvent(QTimerEvent *eve) Q_DECL_OVERRIDE    中央控制枢纽通道
 * void on_Start_clicked()                              系统运行开始控制器
 * void on_Terminate_clicked()                          系统运行终止（暂停）控制器
 * void on_Random_clicked()                             随机生成作业接口
 * void on_continue_2_clicked()                         系统运行继续控制器
 * void on_Suspend_clicked()                            选择进程挂起接口
 * void addtoSuspendQue(SProcess *receive)              将目标进程调进挂起队列
 * void on_DeSuspend_clicked()                          选择进程解挂接口
 * void on_crush_stateChanged(int arg1)                 抢占控制接口
 * void on_slice_stateChanged(int arg1)                 时间片模式控制接口
 * void on_addrassignpatterns_currentIndexChanged(int index)    适应算法控制接口
 * ****************************************************************************
 */
